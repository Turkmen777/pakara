...
def main():
    ...
    print("=" * 70)
    print("📋 ЛОГИ БУДУТ В ФАЙЛЕ bot.log")
    print("=" * 70)
    print("🔧 ДЕБАГ:")
    print("1. Отправьте боту /start")
    print("2. Нажмите '💰 Пополнить счет'")
    print("3. Введите ID и сумму")
    print("4. Проверьте файл bot.log - должна быть строка:")
    print("   'Заявка #XXXX отправлена в группу -1003663534213'")
    print("5. В группе напишите 8 цифр (например: 65656565)")
    print("6. Проверьте логи - должно быть 'Распознан номер: 65656565'")
    print("=" * 70)
